...
abstract class $CategoryDTOCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String img, String color});
}
...
class _$CategoryDTOImpl implements _CategoryDTO {
  ...
  @override
  String toString() {
    return 'CategoryDTO(id: $id, name: $name, img: $img, color: $color)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, img, color);
...
abstract class _CategoryDTO implements CategoryDTO {
  const factory _CategoryDTO(
      ...
      required final String color}) = _$CategoryDTOImpl;
