...
class _IndexScreenState extends State<IndexScreen> {
  ...
  void _filterTasks(TaskFilter? filterValue) {
    ...
    _sortTasks(_selectedSort, _sortOrder);
  }

  void _sortTasks(TaskSortType sortType, SortOrder sortOrder) {
    final sortedTasks = TaskSortUtils().sortTasks(List<TaskDTO>.from(_resultTasks), sortType, sortOrder);
    setState(() {
      _resultTasks.clear();
  ...
  void _filterByStatus(TaskStatus status) {
    final filteredTasks = TaskFilterUtils().filterTasksByStatus(_resultTasks, status);
    setState(() {
